...
class Broker:
    ...
    def on_message(self, message):
        ...
        if len(message.split(";")) >= 2:
            ...
            logger.info("Message received by Broker and inserted into the queue :  " + message)
            self.notify()
        else:
            pass
    ...
    def topic_data(self, subscriber, topic):
        ...
        messages_for_topic = [self.process_message(message)[0] for message in self.messaging_queue if
